...
=== Notice:
Be sure you are forcing / skiping mobile requests e.g. in a before_action like : skip_or_force_mobile BEFORE you are including the Mobylette::RespondToMobileRequests module.
Mobylette adds own before_action to check the session var which would be executed before your filter.

  class ApplicationController < ActionController::Base
    #...

    before_action :skip_or_force_mobile
